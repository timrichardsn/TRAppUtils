...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/TRAppUtils'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tim Richardson' => 'tim@timrichardson.co' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/TRAppUtils.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'TRAppUtils' => ['TRAppUtils/Assets/*.png']
  # }
